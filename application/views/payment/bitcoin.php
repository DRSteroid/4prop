<div id="Inner_shop">
	<div class="blue" id="box2">
		<br />
		<img src="<?php echo base_url();?>design/img/shop/bitcoin-header.png" style="margin-left:5px;"/>
		<br /><br /><br />
		<?php
		...
		?>
			...
			<tbody>
				<tr>
				<!--<th width="90" scope="col"><div align="center">Amount</div></th>-->
...
<?			
		...
		$query = $db->get_where('premium2', array('server' => $this->config->item('page_prefix2'), 'type' => 'bitcoin'));
		$i = 0;
		...
		/*	if(date("d") >= date("3") && date("d") < date("31") && date('Y-m-d H:i:s') > $value['event_date']){
			...
			?>	  
				<tr>
					<!--<td><div align="center"><span style="color:#ffc029"><?=$price?></font></div></td>-->
					...
					<input type="hidden" name="gway" value="bitcoin"/>
	...
	<?php
			...
			{
				echo '<center><h3>Bitcoin payments will be available soon.</h3></center>';
			}
	?>
	</div>
</div>