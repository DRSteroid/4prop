...
<?
//husvét design JAN 1 TŐL ADJA BE O.o
	...
	<nav style="margin-top: 0px;">
		<div class="middle">
			<ul>
				...
				<li><a class="rank" href="<?=$this->config->item('base_url')?>main/rankchar">RANGLISTA</a>
					<ul>
					<li><a href="<?=$this->config->item('base_url')?>main/rankchar">Becsület</a></li>
					<li><a href="<?=$this->config->item('base_url')?>main/rankguild">Céh lista</a></li>
					</ul>
				</li>
				<li><a class="dl popup-open" data-popup-titlebar="false" href="<?=$this->config->item('base_url')?>main/download">LETÖLTÉSEK</a></li>
...
?>				
		<div class="loginBefore">
			...
			<form accept-charset="utf-8" enctype="multipart/form-data" method="post" action="<?=$this->config->item('base_url')?>main/login">

				<div class="emailWrap">
					<span class="emailIcon"></span>
					<input type="email" placeholder="Email cím" name="name" class="email">
				</div>
				<div class="passwordWrap">
					<span class="passwordIcon"></span>
					<input type="password" placeholder="Jelszó" name="password" class="password">
				</div>
				<div class="buttonWrap">
						<input type="submit" class="btn" value="Bejelentkezés">
						<a href="/main/register" data-popup-titlebar="false" id="play" class="popup-open btn">Regisztráció</a>
				</div>
			</form>
			
			<div class="rememberWrap">

				<a href="<?=$this->config->item('base_url')?>main/resendactiv" data-popup-titlebar="false" class="popup-open">Aktiváló link újraküldése</a>

				<a href="<?=$this->config->item('base_url')?>main/lostpw" data-popup-titlebar="false" class="popup-open">Elfelejtett jelszó ?</a>
			</div>
		</div>
...
<div class="fb-page" data-href="https://www.facebook.com/legends4everhu" data-width="331px" data-height="1000px" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/legends4everhu"><a href="https://www.facebook.com/legends4everhu">Classic.legends4ever.eu</a></blockquote></div></div>
...
-->			
			...
			<div class="leftCon">
				<?=$this->View_Model->show_main($page, $param1, $param2, $param3)?>		
			</div>	
		</div>	
	...
	<div class="line"></div>
		...
		<div class="right">
			...
			<dl>
				<dd class="one">
					<ul>
						<li class="first"><span class="footerLine"></span>Egyéb játékok</li>
						
                        	<li><a href="http://legends4ever.eu/">Legends4Ever</a></li>
					</ul>
				</dd>
				<dd class="two">
					<ul>
